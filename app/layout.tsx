...
export const metadata: Metadata = {
  ...
  keywords:"MTA Currency Exchange Grays, foreign exchange UK, 0% commission currency exchange, MoneyGram Grays, Western Union Grays, Ria money transfer, buy currency UK, sell currency UK, foreign exchange, MTA Worldwide Limited",
  openGraph: {
  ...
  category: 'financial services',
    alternates: {
    canonical: 'https://mta-worldwide.co.uk',
  },
};
       ...
       <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "image": "https://mta-worldwide.co.uk/logo.png",
              "@id": "https://mta-worldwide.co.uk",
              "url": "https://mta-worldwide.co.uk",
