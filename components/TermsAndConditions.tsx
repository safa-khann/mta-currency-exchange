...
export default function TermsAndConditions() {
  return (
    <>
      <HeroSection heading="Terms & Conditions" />
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <div className="space-y-3 text-sm sm:text-base fw-medium text-justify">
              <p>
                ...
                The Service may only be used to order foreign currency for travel or genuine
                business purposes. It must not be used for investment, speculation, or any other
                purpose.<br/>
                By ordering currency from us, you confirm that you have read, understood, and
                agreed to these terms and that you will follow all applicable laws and regulations.
                Currency availability depends on stock and may be subject to limits, exchange
                restrictions, and compliance with legal and regulatory requirements, including anti
                money laundering and counter terrorist financing laws.<br/>
                We reserve the right to refuse or cancel any order at our discretion. If payment has
                already been made, a refund will be issued where applicable.<br/>
              </p>
              <p> Please note that exchange rates for USD 1 bills may differ from standard USD notes.
                USD 1 bills cannot be reserved online. To request USD 1 bills, please contact us directly
                on +44 1375 413554.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-sm sm:text-base fw-medium text-justify">
              By placing an order, you confirm that you are acting on your own behalf and for a lawful purpose. You confirm that any currency you buy or sell is legally yours and has not been obtained through illegal activity.<br/>
                ...
                <br/>
                To process your order, all required information must be submitted. We may ask for further details at any time. We reserve the right to verify your identity and to refuse service at our discretion.<br/>
                Cheques are not accepted. If a payment is attempted or made by cheque, the order will be placed on hold and not processed.
                <br/>
                All orders are processed at the exchange rate confirmed at the time of ordering via email. If the market rate changes by more than 1 percent within 24 hours of your order, we reserve the right to amend the rate. Online prices are indicative and not binding.  
            </div>
          </section>
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4">
            ...
            Refunds will be made using the same payment method used for the original transaction. Refunds may take up to 20 days, depending on your card provider. Delivery charges are non refundable once the order has been dispatched.
             <br/>
            For cash transactions, no refunds are available once the transaction is completed. Any refund will be subject to our buy back rates. Please confirm rates with our staff before purchasing.
            </div>
          </section>
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4">
          ...
          <section>
            ...
            <div className="space-y-4 text-sm sm:text-base fw-medium text-justify">
              ...
              <br/>
              If you wish to sell a currency not listed on our website, please contact us directly.
             <br/>
           </div>
          </section>
          <section>
          ...
          {/* know more button */}
           ...
           <section>
            ...
            <div className="space-y-4 text-sm sm:text-base fw-medium text-justify">
                ...
                Address: 54–56 High Street, Grays, RM17 6NA, United Kingdom
            </div>
          </section>
        </div>
      </div>
