...
const MoneyTransferComp:React.FC<MoneyTransferProps> = ({
  ...
  return (
    <>
       {/* Authorised */}
       {showAuth && (
        <div id="money-transfer" className=" w-full px-4 pt-9 sm:pt-14 sm:px-8 lg:px-18 pb-5 sm:pb-10">
        ...
        {/* Global partners */}
        {showGlobalPartners && (
        <div className=" w-full px-4 pt-10 sm:pt-0 md:pt-8 sm:px-8 lg:px-18 pb-0">
